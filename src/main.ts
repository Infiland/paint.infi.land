...
function hydrateJoinDefaults(usernameInput: HTMLInputElement, colorInput: HTMLInputElement, colorPicker: HTMLInputElement): void {
  let storedName = "";
...
const joinOverlay = getRequiredElement<HTMLElement>("joinOverlay");
const joinForm = getRequiredElement<HTMLFormElement>("joinForm");
const joinMessage = getRequiredElement<HTMLElement>("joinMessage");
const usernameInput = getRequiredElement<HTMLInputElement>("usernameInput");
const colorInput = getRequiredElement<HTMLInputElement>("colorInput");
const toolbar = getRequiredElement<HTMLElement>("toolbar");
const colorPicker = getRequiredElement<HTMLInputElement>("colorPicker");
const smoothingToggle = getRequiredElement<HTMLButtonElement>("smoothingToggle");
const themeToggle = getRequiredElement<HTMLButtonElement>("themeToggle");
const zoomLevel = getRequiredElement<HTMLElement>("zoomLevel");
const zoomInBtn = getRequiredElement<HTMLButtonElement>("zoomInBtn");
const zoomOutBtn = getRequiredElement<HTMLButtonElement>("zoomOutBtn");
const resetViewBtn = getRequiredElement<HTMLButtonElement>("resetViewBtn");
